        ...
        <div class="about-bottom">
            <div class="col-md-6 w3l_about_bottom_left">
                <div class="video-grid-single-page-agileits">
                    <img src="images/r1.png" alt="" class="img-responsive" style="height: 700px;"/> 
                </div>
            </div>
                    ...
                    <div class="header-w3l">
                        ...
                        <form action="AddRoom" method="post" class="mod2">
                            <ul>
                                ...
                                <li class="text"> Room Capacity :  </li>
                                <li <li class="agileits-main"><i class="" aria-hidden="true"></i><input name="ram" type="text" required=""></li>
                                <li class="text"> Floor : </li>
                                <li <li class="agileits-main"><i class="" aria-hidden="true"></i><input name="ip" type="text" required=""></li>
                                </ul>
                            <div class="clearfix"></div>
