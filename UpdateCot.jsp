...
<html lang="zxx">
    <head>
        <title>Saline Level Monitoring</title>
        <!-- Meta tag Keywords -->
    ...
    <body>
        ...
        <div id="mail" class="contact">
            <div class="container">
                <div class="w3l-form">
                    <h1 class="w3l-title"><center> UPDATE COT DETAILS </center></h1>
                ...
                discharge=rs.getString("admit");
                            ...
                            %>
                              <tr>
                                ...
                                <td><a href="Assign.jsp?<%=cid%>">Update</a></td>
                                <%}%>
                            </tr>                           
                        </table>
                    </div>
