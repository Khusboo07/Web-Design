                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="UpdateCot.jsp" >Delete Cot</a></li>
                                        </ul>
                                    </li>
            ...
            <div class="col-md-6 w3l_about_bottom_right one">
                <div class="abt-w3l">
                    <div class="header-w3l">
                        ...
                        <form action="AddCot" method="post" class="mod2">
                            <ul>
                                <li class="text"> Cot Id :  </li>
                                <li class="agileits-main"><i class="" aria-hidden="true"></i><input name="number" type="text" required=""></li>
                                 <li class="text"> Room Id :  </li>
                                <li <li class="agileits-main"><i class="" aria-hidden="true"></i><input name="roomid" type="text" required=""></li>
                                <li class="text"> Patient Name :  </li>
                                <li <li class="agileits-main"><i class="" aria-hidden="true"></i><input name="patient" type="text" required=""></li>
                              
                            
                              <li class="text"> Admit Date : </li>
