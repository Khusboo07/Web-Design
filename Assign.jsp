...
<html lang="zxx">
    ...
    <body>
        ...
        <%
            ...
            String discharge = "";
            String cid = "";
            cid = request.getQueryString();
            Connection con = DbConnection.getConn();
            Statement st = con.createStatement();
            String query = "select * from cot where cot_id='" + cid + "'";
            ResultSet rs = st.executeQuery(query);
            while (rs.next()) {
                cid = rs.getString("cot_id");
                rid = rs.getString("room_id");
                patient = rs.getString("patient");
                discharge = rs.getString("admit");
            }
        ...
        <div class="about-bottom">
            <div class="col-md-6 w3l_about_bottom_left">
                <div class="video-grid-single-page-agileits">
                    <img src="images/b1.jpg" alt="" class="img-responsive" style="height: 700px;"/> 
                </div>
            </div>
            <div class="col-md-6 w3l_about_bottom_right one">
                <div class="abt-w3l">
                    <div class="header-w3l">
                        ...
                        <form action="Assign" method="post" class="mod2">
                            <ul>
                                <li class="text"> Cot ID :  </li>
                                <li class="agileits-main"><i class="" aria-hidden="true"></i><input name="cid" value="<%=cid%>" type="text" required=""></li>

                                <li class="text"> Room ID :  </li>
                                <li class="agileits-main"><i class="" aria-hidden="true"></i><input name="rid" value="<%=cid%>" type="text" required=""></li>

                                <li class="text"> Patient Name : </li>
                                <li <li class="agileits-main"><i class="" aria-hidden="true"></i><input name="patient" value="<%=patient%>" type="text" required=""></li>
                                 <li class="text"> Nurse Name  :  </li>
        ...
        <div class="w3layouts_copy_right">
            <div class="container">
                <p>© 2018Scholarly. All rights reserved | Design by <a href="http://dypic.in"> Dr.D.Y.Patil School Of Engineering And Technology.</a></p>
            </div>
        </div>
        <!-- //footer -->
